...
In [Data Files](./Data%20Files) you can find the data files used in the Ciernia Lab morphology analysis. This includes both a data frame with the raw individual feature values, cluster, and first 2 PCAs as well as cluster percentage results/data. 
