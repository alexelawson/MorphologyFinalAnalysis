...
Idents(combined_all_microglia) <- "condition"
table(Idents(combined_all_microglia))

Idents(combined_female) <- "condition"
table(Idents(combined_female))
...
# Save male DEGs
write.csv(deg_combined_male, "male_cold_vs_con.csv")

# Filter male DEGs
up_male <- deg_combined_male[deg_combined_male$avg_log2FC > 0 & deg_combined_male$p_val_adj < 0.1, ]
down_male <- deg_combined_male[deg_combined_male$avg_log2FC < 0 & deg_combined_male$p_val_adj < 0.1, ]
