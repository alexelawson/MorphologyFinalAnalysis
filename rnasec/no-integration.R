...
combined <- merge(
  x = control,
  y = cold,
  add.cell.ids = c("CON", "COLD"),   # prefixes for cell barcodes so you can always tell them apart
  project = "MicrogliaStudy"              # whatever project name you like
)
...
View(female_cells_control_subset)
